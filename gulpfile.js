...
gulp.task('nunjucks', function() {
  return gulp.src('frontend/pages/**/*.html')
    ...
    .pipe(data(function() { return require('./frontend/data/bravo.json') }))
    .pipe(data(function() { return require('./frontend/data/banoffi.json') }))
    .pipe(data(function() { return require('./frontend/data/ekaterinburg.json') }))
